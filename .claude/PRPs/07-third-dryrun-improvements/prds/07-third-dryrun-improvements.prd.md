...
| 4   | 卓を増やす／再開               | reopen / 卓追加 repository・service・UI、autoSeatLateEntry との責務整理   | complete | -        | 3       | [completed/phase-4-add-reopen-table.plan.md](../plans/completed/phase-4-add-reopen-table.plan.md) ／ [report](../reports/phase-4-add-reopen-table-report.md) |
