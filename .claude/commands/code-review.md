...
2. **PRP artifacts** — Check `.claude/PRPs/<NN>-<prd-slug>/reports/` and `.claude/PRPs/<NN>-<prd-slug>/plans/` for implementation context related to this PR (artifacts are organized per-PRD)
...
Create review artifact at `.claude/PRPs/<NN>-<prd-slug>/reviews/pr-<NUMBER>-review.md` — same `<NN>-<prd-slug>` PRD-folder convention used by plans/reports.
...
Artifacts:
  Review: .claude/PRPs/<NN>-<prd-slug>/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
